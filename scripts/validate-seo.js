...
const validateSEO = () => {
  ...
  if (fs.existsSync(sitemapPath)) {
    ...
    const requiredPages = [
      { path: '/', url: 'https://ancel-ajanga-portfolio.netlify.app' },
      { path: '/about', url: 'https://ancel-ajanga-portfolio.netlify.app/about' },
      { path: '/case-studies', url: 'https://ancel-ajanga-portfolio.netlify.app/case-studies' },
      { path: '/blog', url: 'https://ancel-ajanga-portfolio.netlify.app/blog' },
      { path: '/contact', url: 'https://ancel-ajanga-portfolio.netlify.app/contact' }
    ];
